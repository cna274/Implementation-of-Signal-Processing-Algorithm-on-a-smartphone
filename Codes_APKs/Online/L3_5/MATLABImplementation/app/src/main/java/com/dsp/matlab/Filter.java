	...
	public void run() {
		try {
			...
			loop:while(true) {
				...
				currentFrame.setFiltered(Filters.compute(currentFrame.getFloats(), Settings.blockSize, Settings.option, Settings.Resistance,
						Settings.Inductance, Settings.Capacitance));
