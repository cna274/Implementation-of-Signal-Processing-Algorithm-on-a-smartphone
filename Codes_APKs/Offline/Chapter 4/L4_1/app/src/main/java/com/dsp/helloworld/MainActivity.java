...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private EditText etAvalue,etTvalue,etNvalue,etwvalue;
    ...
    public native float[] getArray(float opvalue, float A, float T, float N, float w);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btncompute) {
            ...
            var = getArray(opvalue, A, T, N, w);

            main_2.graph_var = new Float[var.length-3];
