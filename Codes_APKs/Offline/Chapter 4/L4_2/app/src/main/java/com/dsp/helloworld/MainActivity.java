...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private EditText etAvalue,etTvalue,etNvalue,etwvalue,etRvalue,etCvalue;
    ...
    public native float[] getArray(float opvalue, float A, float T, float N, float w, float R_1, float C);
    ...
    private void init() {
        ...
        etTvalue = (EditText) findViewById(R.id.etTvalue);
        etNvalue = (EditText) findViewById(R.id.etNvalue);
        etwvalue = (EditText) findViewById(R.id.etwvalue);
        etRvalue = (EditText) findViewById(R.id.etRvalue);
        etCvalue = (EditText) findViewById(R.id.etCvalue);
    ...
    public void onClick(View v) {
        ...
        TextView cna = (TextView) findViewById(R.id.log);
        float[] var;
        float opvalue,A,T,N,w,R_1,C;

        String A_val = etAvalue.getText().toString();
        String T_val = etTvalue.getText().toString();
        String N_val = etNvalue.getText().toString();
        String w_val = etwvalue.getText().toString();
        String R_val = etRvalue.getText().toString();
        String C_val = etCvalue.getText().toString();
        ...
        T = Float.parseFloat(T_val);
        N = Float.parseFloat(N_val);
        w = Float.parseFloat(w_val);
        R_1 = Float.parseFloat(R_val);
        C = Float.parseFloat(C_val);

        if (v.getId() == R.id.btncompute) {

            var = getArray(opvalue, A, T, N, w,R_1,C);
