...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private EditText etAvalue, etDvalue;
    ...
    public native float[] getArray(float opvalue, float mode, float delay);
    ...
    private void init() {
        ...
        etDvalue = (EditText) findViewById(R.id.etDvalue);
    ...
    public void onClick(View v) {
        ...
        TextView cna = (TextView) findViewById(R.id.log);
        float[] var;
        float opvalue,mode, delay;

        String A_val = etAvalue.getText().toString();
        String D_val = etDvalue.getText().toString();
        ...
        mode = Float.parseFloat(A_val);
        delay = Float.parseFloat(D_val);

        if (v.getId() == R.id.btncompute) {

            var = getArray(opvalue, mode, delay);
