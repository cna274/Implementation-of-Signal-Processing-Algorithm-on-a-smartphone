...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView tvresult, settingCheckBox, settingList;
    private EditText etavalue, etbvalue, etdelta, etoption;
    ...
    public native float[] getArray(float avalue, float bvalue, float dvalue, float opvalue);
    ...
    public void onClick(View v) {
        ...
        TextView cna = (TextView) findViewById(R.id.log);
        float[] var;
        float avalue =1, bvalue=2, dvalue=1,opvalue=1;
        String aval = etavalue.getText().toString();
        String bval = etbvalue.getText().toString();
...
//        String option = etoption.getText().toString();
        ...
        avalue = Float.parseFloat(aval);
        bvalue = Float.parseFloat(bval);
        ...
        if (v.getId() == R.id.btncompute) {
            ...
            var = getArray(avalue, bvalue, dvalue, opvalue);
