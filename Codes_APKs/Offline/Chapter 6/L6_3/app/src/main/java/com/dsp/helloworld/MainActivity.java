...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public native float[] getArray(float opvalue, float k, float tone );
    ...
    public void onClick(View v) {
        ...
        k = Float.parseFloat(A_val);
        tone = Float.parseFloat(F_val);


        if (v.getId() == R.id.btncompute) {

            var = getArray(opvalue, k, tone);
